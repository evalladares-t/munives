								...
								<div class="header-column justify-content-end">
									<div class="header-row">
										<ul class="header-social-icons social-icons d-none d-sm-block social-icons-clean">
											<li class="social-icons-facebook"><a href="#" onClick="window.open('pages/transparencia/normas_emitidas/resoga','popup', 'width=1200px,height=700px')"  title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
				...
				<div role="main" class="main">
						...
						<section id="IDacceos" class="section section-height-2 bg-color-grey-scale-1  border-0 m-0">
							<div class="container py-2">
								...
								<div id="combinationFilters" class="filters mb-3">

									<div class="row">

										<div class="col-lg-6">

											<h5 class="text-uppercase mb-3">Accesos Directos</h5>
											<ul id="accesosdirectos" class="nav nav-pills sort-source sort-source-style-3 portfolio-filter-group" data-filter-group="group1">
												<li id="todos" class="nav-item active" data-option-value=""><a class="nav-link text-1 text-uppercase active" href="#">Ver Todos</a></li>
												<li id="menos" class="nav-item " data-option-value=".vermenos" ><a  class="nav-link text-1 text-uppercase " href="#">Ver Menos</a></li>
											</ul>
								...
								<div class="sort-destination-loader sort-destination-loader-showing">
									<div class="row portfolio-list">
												...
												<a href="portfolio-single-wide-slider.html">
													<span class="thumb-info thumb-info-lighten border-radius-0">
														<span class="thumb-info-wrapper border-radius-0">
															...
															<span class="thumb-info-title">
																<span class="thumb-info-inner"><span style="font-size: 15px;">Licencia de
																		Funcionamiento</span></span>
															</span>
										...
										<div class="col-12 col-sm-6 col-lg-3 isotope-item vermenos">
											<div class="portfolio-item">
												<a href="portfolio-single-wide-slider.html">
													<span class="thumb-info thumb-info-lighten border-radius-0">
														<span class="thumb-info-wrapper border-radius-0">
															<img src="img/accesodirectos/atencionciudadana.jpg" class="img-fluid border-radius-0"
																alt="">
															<span class="thumb-info-title">
													...
													<span class="thumb-info thumb-info-lighten border-radius-0">
														<span class="thumb-info-wrapper border-radius-0">
															<img src="img/accesodirectos/buzonsugerencias.jpg" class="img-fluid border-radius-0"
																alt="">
															<span class="thumb-info-title">
																<span class="thumb-info-inner">Buzón de Sugerencias</span>
															</span>
										...
										<div class="col-12 col-sm-6 col-lg-3 isotope-item vermenos">
											<div class="portfolio-item">
												<a href="portfolio-single-wide-slider.html">
													<span class="thumb-info thumb-info-lighten border-radius-0">
														<span class="thumb-info-wrapper border-radius-0">
															<img src="img/accesodirectos/villaatiende.jpg" class="img-fluid border-radius-0" alt="">
															<span class="thumb-info-title">
																<span class="thumb-info-inner">Villa @tiende</span>
															</span>
										...
										<div class="col-12 col-sm-6 col-lg-3 isotope-item vermenos">
											<div class="portfolio-item">
												<a href="portfolio-single-wide-slider.html">
													<span class="thumb-info thumb-info-lighten border-radius-0">
														<span class="thumb-info-wrapper border-radius-0">
															<img src="img/accesodirectos/datosabiertos.jpg" class="img-fluid border-radius-0"
																alt="">
															<span class="thumb-info-title">
										...
										<div id="IDitemfinal" class="col-12 col-sm-6 col-lg-3 isotope-item vermenos">
											<div class="portfolio-item">
												<a href="portfolio-single-wide-slider.html">
													<span class="thumb-info thumb-info-lighten border-radius-0">
														<span class="thumb-info-wrapper border-radius-0">
						...
						<section id="IDnumerostelefonos" class="section section-height-1 border-0 mt-0 mb-0 pt-4">
							...
							<div class="container py-2">
								<div class="row">
									<div class="col-lg-6">
										<h5 class=" text-color-lighttext-uppercase mb-4">NÚMEROS DE UTILIDAD</h5>
									</div>
								</div>
									...
									<div class="col">
										<div class="row counters">
											...
											<div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
												<div class="counter counter-primary">
													<strong>*2000</strong>
													<label>Serenazgo</label>
												</div>
											</div>
											<div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
												<div class="counter counter-primary">
													<strong>319-2530</strong>
													<label>Central MVES</label>
												</div>
											</div>
										</div>
									</div>
						...
						<section id="IDvideos" class="section section-height-2 bg-color-grey-scale-1 m-0 border-0">
							<div class="container py-2">
								<div class="row">
									<div class="col-lg-6">
										<h5 class=" text-color-lighttext-uppercase mb-4">ACTUALIDAD</h5>
									</div>
								</div>
											...
											<article>
												<div
													...
													<div class="thumb-info-wrapper thumb-info-wrapper-opacity-6">
														<img src="img/cardlinea/villaverde.png" class="img-fluid"
										...
										<a href="blog-post.html">
											<article>
												<div
													class="thumb-info thumb-info-no-borders thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
													<div class="thumb-info-wrapper thumb-info-wrapper-opacity-6">
														<img src="img/cardlinea/villaemprende.png" class="img-fluid"
															alt="How To Take Better Concert Pictures in 30 Seconds">
														<div class="thumb-info-title bg-transparent p-4">
										...
										<a href="blog-post.html">
											<article>
												<div
													class="thumb-info thumb-info-no-borders thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
													<div class="thumb-info-wrapper thumb-info-wrapper-opacity-6">
														<img src="img/cardlinea/villaconstruye.png" class="img-fluid"
															alt="How To Take Better Concert Pictures in 30 Seconds">
														<div class="thumb-info-title bg-transparent p-4">
										...
										<a href="blog-post.html">
											<article>
												<div
													class="thumb-info thumb-info-no-borders thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
													<div class="thumb-info-wrapper thumb-info-wrapper-opacity-6">
														<img src="img/cardlinea/villasaludable.png" class="img-fluid"
															alt="How To Take Better Concert Pictures in 30 Seconds">
														<div class="thumb-info-title bg-transparent p-4">
										...
										<a href="blog-post.html">
											<article>
												<div
													class="thumb-info thumb-info-no-borders thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
													<div class="thumb-info-wrapper thumb-info-wrapper-opacity-6">
														<img src="img/cardlinea/villasostenible.png" class="img-fluid"
															alt="How To Take Better Concert Pictures in 30 Seconds">
														<div class="thumb-info-title bg-transparent p-4">
