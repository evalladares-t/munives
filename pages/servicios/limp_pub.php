	...
	<body>
		...
		<div class="body">
													...
													<nav class="collapse">
														<ul class="nav nav-pills" id="mainNav">
															...
															<li class="dropdown dropdown-full-color dropdown-light dropdown-mega">
																<a class="dropdown-item dropdown-toggle" href="../municipalidad/">
																	La Municipalidad
																</a>
		
															</li>
															<li class="dropdown dropdown-full-color dropdown-light">
																<a class="dropdown-item dropdown-toggle" href="../ciudad/">
																	La Ciudad
																</a>
															...
															<li class="dropdown dropdown-full-color dropdown-light">
																<a class="dropdown-item dropdown-toggle" href="../participacion/">
																	Participación
																</a>
                ...
                <div role="main" class="main" style="text-align: center;">
                    <img style="width: 65%;" src="../../img/generic/sitio-en-contruccion.jpg">
                </div>
